        ...
        <div class="form-content">
            ...
            <div class="resume-section">
                <div class="resume-container">
                    <label>Resume</label>
                    <?php if (!empty($resumePdf)): ?>
                        <div id="resumePreview" class="resume-item">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="PDF icon">
                            <div class="resume-info">
                                <span id="resumeName"><?php echo basename($resumePdf); ?></span>
                                <small id="resumeSize"><?php echo filesize($resumePdf) / 1024 . ' KB'; ?></small>
                            </div>
                            <a href="<?php echo $resumePdf; ?>" id="resumeDownload" download>
