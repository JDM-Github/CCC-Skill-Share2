                ...
                if (!isset($_SESSION["account"])) {
                    ...
                    if ($_SESSION['verified'] == "0")
                        echo '<li class="nav-item">
                            <button type="button" class="btn btn-primary nav-link" data-bs-toggle="modal" data-bs-target="#verifyModal">
                                Verify Account
                            </button>
                        </li>';
...
<div class="modal fade" id="verifyModal" tabindex="-1" aria-labelledby="verifyModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="database/verify_email.php" method="POST">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="verificationCode" class="form-label">Enter Verification Code</label>
                        <input type="text" class="form-control" id="verificationCode" name="generated" required>
                    </div>
                    <div class="d-grid">
                        <button type="button" id="sendCodeBtn" class="btn btn-outline-secondary"
...
<script>
    function sendVerificationCode() {
        fetch('database/send_verification.php', {
            method: 'POST',
            headers: {
